// api key from TMDB
const api="api_key=12cd445080cd9f586dab7e8113382397";
// base url of the site
const base_url="https://api.themoviedb.org/3";

const banner_url="https://image.tmdb.org/t/p/original";
const img_url="https://image.tmdb.org/t/p/w500";  // You can change w185 to your prefered
...
fetch(requests.fetchNetflixOriginals)
  ...
  .then((data) => {
    ...
    //after every refresh the movie will be changed
